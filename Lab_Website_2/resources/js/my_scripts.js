...
function loadStatsPage()
{
	...
	for (var i = 2; i<14; i++)
	{
			...
			var home = parseInt(document.getElementById("stats_table").rows[i].cells[2].innerHTML,10);
			var away = parseInt(document.getElementById("stats_table").rows[i].cells[3].innerHTML, 10);
			if (home>away)
			{
				cuwin = cuwin+1;
			...
			{
				awaywin = awaywin +1;
				document.getElementById("stats_table").rows[i].cells[4].innerHTML = 
				document.getElementById("stats_table").rows[i].cells[1].innerHTML;
			}

		
	}
	document.getElementById("wins").innerHTML = cuwin;
	document.getElementById("losses").innerHTML = awaywin;
}
...
function loadPlayersPage()
{
	...
	// 	fruit_index++;
	// 	//If we've gone too far, reset the index to 0.
	// 	{
	// 		fruit_index = 0;
	// 	}
}
